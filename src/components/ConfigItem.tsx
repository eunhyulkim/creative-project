...
import { Config, ConfigNames, RangeType, SelectType, CheckboxType, InputType } from 'scripts/Config';
import { Heading, Toggle, Description, Range, Select, Checkbox, Input } from './type';
